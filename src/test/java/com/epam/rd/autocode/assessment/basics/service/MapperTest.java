...
class MapperTest {
    ...
    public static Stream<Arguments> casesCsvToOrder() {
        return Stream.of(
                Arguments.of(new String[] { "1", "1", "1", "1", "1122-11-22T00:00", "1122-11-23T00:00", "1" },
                        new Order(1, 1, 1, 1,
                ...
                Arguments.of(new String[] { "1", "1", "1", "1", "", "", "1" },
                        new Order(1, 1, 1, 1, null, null, new BigDecimal("1"))
                )
        );
    }
    ...
    public static Stream<Arguments> casesVehicleToCsv() {
        return Stream.of(
                ...
                Arguments.of(
                        new Vehicle(0, "m", "md", "ch", 1, 2, "c",
                                "lp", 0, null, (char) 0, null),
                        new String[] { "0", "m", "md", "ch", "1", "2", "c", "lp", "0", null, String.valueOf((char) 0),
                                null }
                ),
                Arguments.of(
                        new Vehicle(0, "m", "", "ch", 1, 2, "c",
                                "lp", 0, null, (char) 0, null),
                        new String[] { "0", "m", "", "ch", "1", "2", "c", "lp", "0", null, String.valueOf((char) 0),
                                null }
                )
        );
    }
